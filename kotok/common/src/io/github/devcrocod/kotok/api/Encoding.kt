...
public interface Encoding {
     ...
     */
    public val VERY_LARGE_TOKENIZER_BYTE_THRESHOLD_KEY: String // TODO
     ...
     */
    public fun encode(text: String): TokenArray
     ...
     * @throws UnsupportedOperationException if the text contains special tokens which are not supported for now
     */
    public fun encode(text: String, maxTokenCount: Int): EncodingResult
     ...
     * @return the array of token ids
     */
    public fun encodeOrdinary(text: String): TokenArray
     ...
     * @return the [EncodingResult] containing a array of token ids and whether the tokens were truncated due to the maxTokens parameter
     */
    public fun encodeOrdinary(text: String, maxTokenCount: Int): EncodingResult
     ...
     * @return the number of tokens
     */
    public fun countTokensOrdinary(text: String): Int
     ...
     */
    public fun decode(tokens: IntArray): String = decode(TokenArray(tokens, tokens.size))
     ...
     * @throws IllegalArgumentException if the list contains invalid token ids
     */
    public fun decode(tokens: TokenArray): String
     ...
     * @throws IllegalArgumentException if the list contains invalid token ids
     */
    public fun decodeBytes(tokens: IntArray): ByteArray = decodeBytes(TokenArray(tokens, tokens.size))
     ...
     * @throws IllegalArgumentException if the list contains invalid token ids
     */
    public fun decodeBytes(tokens: TokenArray): ByteArray
} 